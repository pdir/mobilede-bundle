...
$GLOBALS['TL_LANG']['tl_content']['pdir_md_combine_filter'] = ['Combine Filters', 'If active, the filters are combined with each other, e.g. only the vehicle models of one brand are displayed.'];
$GLOBALS['TL_LANG']['tl_content']['pdir_md_show_net_price'] = ['Show net price', 'If active, the net price is displayed in the list and detail view.'];
$GLOBALS['TL_LANG']['tl_content']['pdir_md_show_gross_price'] = ['Show gross price', 'If active, the gross price is displayed in the list and detail view.'];
