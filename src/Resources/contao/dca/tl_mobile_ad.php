...
$GLOBALS['TL_DCA']['tl_mobile_ad'] = [
    ...
    'fields' => [
        ...
        'ad_id' => [
            'label' => &$GLOBALS['TL_LANG']['tl_mobile_ad']['ad_id'],
            'exclude' => true,
            'search' => true,
            'sorting' => true,
            'flag' => 1,
        ...
        'vehicle_category' => [
            ...
            'flag' => 1,
            'inputType' => 'select',
            'options' => $GLOBALS['TL_LANG']['tl_mobile_ad']['vehicle_category']['options'],
            'eval' => ['mandatory' => false, 'maxlength' => 255, 'tl_class' => 'w50', 'includeBlankOption' => true],
        ...
        'vehicle_free_text' => [
            'label' => &$GLOBALS['TL_LANG']['tl_mobile_ad']['vehicle_free_text'],
            'exclude' => true,
            'search' => true,
            'sorting' => true,
            'flag' => 1,
        ...
        'emission_fuel_consumption_unit' => [
            'label' => &$GLOBALS['TL_LANG']['tl_mobile_ad']['emission_fuel_consumption_unit'],
            'exclude' => true,
            'search' => true,
            'sorting' => true,
            'flag' => 1,
        ...
        'api_images' => [
            'label' => &$GLOBALS['TL_LANG']['tl_mobile_ad']['api_images'],
            'exclude' => true,
            'search' => true,
            'sorting' => true,
            'flag' => 1,
        ...
        'features' => [
            'label' => &$GLOBALS['TL_LANG']['tl_mobile_ad']['features'],
            'exclude' => true,
            'search' => true,
            'sorting' => true,
            'flag' => 1,
            'inputType' => 'select',
            'options' => $GLOBALS['TL_LANG']['tl_mobile_ad']['features']['options'],
