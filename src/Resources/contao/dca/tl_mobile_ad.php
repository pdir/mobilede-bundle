...
$GLOBALS['TL_DCA']['tl_mobile_ad'] = [
    ...
    'fields' => [
        ...
        'vehicle_class' => [
            ...
            'flag' => 1,
            'inputType' => 'select',
            'options' => array('agriculturalVehicle','bus','car','constructionMachine','forkliftTruck','motorbike','motorhome','semiTrailer','semiTrailerTruck','trailer','truckOver7500','vanUpTo7500'),
        ...
        'features_agriculturalVehicle' => [
            ...
            'eval' => ['mandatory' => true, 'maxlength' => 255, 'tl_class' => 'w50', 'includeBlankOption' => true, 'multiple' => true, 'chosen' => true],
            'sql' => "text NULL"
        ],
        'features_bus' => [
