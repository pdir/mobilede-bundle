...
$GLOBALS['TL_DCA']['tl_content']['fields']['pdir_md_promotion_corner_sticky'] = array
(
	'label' => &$GLOBALS['TL_LANG']['tl_content']['pdir_md_promotion_corner_sticky'],
	'exclude' => true,
	'inputType' => 'checkbox',
	'eval' => array(
		'submitOnChange' => true,
