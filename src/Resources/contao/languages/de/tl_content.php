...
$GLOBALS['TL_LANG']['tl_content']['pdir_md_customer_id'] = ['Mobile.de ID', 'Bitte geben Sie hier Ihre Mobile.de ID an. Wenn gesetzt, wird die ID als alternative zur Kundenummer verwendet.'];
$GLOBALS['TL_LANG']['tl_content']['pdir_md_customer_number'] = ['Mobile.de Kundennummer', 'Bitte geben Sie hier Ihre Mobile.de Kundenummer an.'];
...
$GLOBALS['TL_LANG']['tl_content']['pdir_md_corner_color'] = ['Eckband Farbe', 'Hier kannst du eine der vordefinierten Farben für das Eckband verwenden. Andere Farben kannst du per CSS Definition überschreiben.'];
...
$GLOBALS['TL_LANG']['tl_content']['pdir_md_promotion_corner_color'] = ['Eckband Farbe (Promotion)', 'Hier kannst du eine der vordefinierten Farben für das Eckband verwenden. Andere Farben kannst du per CSS Definition überschreiben.'];
$GLOBALS['TL_LANG']['tl_content']['pdir_md_corner_position'] = ['Eckband Position', 'Bitte wähle die gewünschte Position des Eckbandes aus.'];
...
$GLOBALS['TL_LANG']['tl_content']['pdir_md_promotion_corner_position'] = ['Eckband Position (Promotion)', 'Bitte wähle die gewünschte Position des Eckbandes aus.'];
$GLOBALS['TL_LANG']['tl_content']['pdir_md_promotion_corner_shadow'] = ['Eckband Schatten anzeigen (Promotion)', 'Wenn aktiv wird dem Eckband ein Schatten hinzugefügt.'];
$GLOBALS['TL_LANG']['tl_content']['pdir_md_corner_shadow'] = ['Eckband Schatten anzeigen', 'Wenn aktiv wird dem Eckband ein Schatten hinzugefügt.'];
