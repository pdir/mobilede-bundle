...
$GLOBALS['TL_LANG']['MOBILEDE']['emailBody'] = '<br>Hallo pdir Team,<br><br>wir haben die mobile.de Schnittstelle für Contao 4 installiert, getestet und würden diese gerne erwerben und für unseren Kunden einsetzen.<br><br>Die Domain lautet: [HIER DOMAIN ANGEBEN] <br><br>Die Rechnung soll auf folgende Adresse ausgestellt werden:<br><br>[HIER RECHNUNGSANSCHRIFT ANGEBEN]<br><br>Die Serverdaten aus dem Backend lauten wie folgt:<br>IP: :IP:<br>Hostname: :HOST: <br>Domain: :DOMAIN: <br><br>Mit freundlichen Grüßen<br>';
